...
- **lab 5(updator):** За допомогою нього можна додавати дані з файлу csv і вручну до 'database.db'.
- **lab 5(Block_processor):** Кожні 2 секунди перевіряє 'database.db' і друкує список блоків в таблиці 'block'
- **Database Layer (Labs 4-5):** Реалізація SQL бекенду. Включає роботу з SQLite/PostgreSQL, створення таблиць, вставку блоків та вибірку даних.
